...
public class JwtHelper {
    ...
    // Set your secret key here (you can store it in application.properties securely)
    private final String SECRET_KEY = "your-256-bit-secret-your-256-bit-secret"; // 32+ chars for HS256
